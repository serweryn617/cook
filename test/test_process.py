...
def test_process_runner_default_executable(mock_subprocess_run, mock_shutil_which) -> None:
...
@patch("shutil.which")
@patch("subprocess.run")
def test_process_runner_default_executable_nt(mock_subprocess_run, mock_shutil_which) -> None:
...
@patch("shutil.which")
@patch("subprocess.run")
def test_process_runner_custom_executable(mock_subprocess_run, mock_shutil_which) -> None:
...
@patch("shutil.which")
@patch("subprocess.run")
def test_process_runner_custom_executable_not_found(mock_subprocess_run, mock_shutil_which) -> None:
